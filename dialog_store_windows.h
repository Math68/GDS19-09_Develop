...
enum Components{Capacitor=0, Connector, Diode, Inductor, IntegratedCircuit, Led, Quartz, Relay, Resistor, Transistor, Fuse, Switch};
...
private:
    ...
    QLineEdit *Lineedit_store_spacing;
    QLineEdit *Lineedit_store_contacts;
